...
INPUTFILE="protate_image.jpg"
INTERNALFILE="image.jpg"
OUT_INTERNALFILE="grayscale_image.jpg"
 #-----------------------INFO TYPE 2-----
 USER="loya"
 ...
 UENV="libv=sharp" 
 #-------------------------INFOTYPE 4---
 DOCKERIMAGE="grayscale"
 DOCKERCONTAINER="rungrayscale"
...
node download_wfile.js  $OBJECTCONTAINER $USERWORK $INVOL  $INPUTFILE $INTERNALFILE
...
node upload_file.js  $OBJECTCONTAINER $USERWORK $OUTVOL  $OUT_INTERNALFILE
